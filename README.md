...
Для генерации ежедневного отчета:

sql
CALL generate_daily_report('2024-01-15');
Для обновления сегментов клиентов:
...
Хранимые процедуры для часто выполняемых операций

Партиционирование данных по дате (рекомендация для продакшена)
